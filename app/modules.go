...
import (
	...
	appparams "github.com/figment-networks/osmosis/v8/app/params"

	// Upgrades from earlier versions of Osmosis
	_ "github.com/figment-networks/osmosis/v8/client/docs/statik"

	// Modules that live in the Osmosis repository and are specific to Osmosis
	"github.com/figment-networks/osmosis/v8/x/claim"
	claimtypes "github.com/figment-networks/osmosis/v8/x/claim/types"

	// Epochs: gives Osmosis a sense of "clock time" so that events can be based on days instead of "number of blocks"
	"github.com/figment-networks/osmosis/v8/x/epochs"
	epochstypes "github.com/figment-networks/osmosis/v8/x/epochs/types"

	// Generalized Automated Market Maker
	"github.com/figment-networks/osmosis/v8/x/gamm"
	...
	"github.com/figment-networks/osmosis/v8/x/incentives"
	incentivestypes "github.com/figment-networks/osmosis/v8/x/incentives/types"

	// Lockup: allows tokens to be locked (made non-transferrable)
	"github.com/figment-networks/osmosis/v8/x/lockup"
	...
	"github.com/figment-networks/osmosis/v8/x/mint"
	minttypes "github.com/figment-networks/osmosis/v8/x/mint/types"

	// Pool incentives:
	poolincentives "github.com/figment-networks/osmosis/v8/x/pool-incentives"
	poolincentivesclient "github.com/figment-networks/osmosis/v8/x/pool-incentives/client"
	poolincentivestypes "github.com/figment-networks/osmosis/v8/x/pool-incentives/types"

	// Superfluid: Allows users to stake gamm (bonded liquidity)
	superfluid "github.com/figment-networks/osmosis/v8/x/superfluid"
	superfluidclient "github.com/figment-networks/osmosis/v8/x/superfluid/client"
	superfluidtypes "github.com/figment-networks/osmosis/v8/x/superfluid/types"

	// txfees: Allows Osmosis to charge transaction fees without harming IBC user experience
	"github.com/figment-networks/osmosis/v8/x/txfees"
	txfeestypes "github.com/figment-networks/osmosis/v8/x/txfees/types"
