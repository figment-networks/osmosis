...
replace (
	...
	// cometbft is replaced to print custom app hash logs. Using branch osmo-v25/v0.37.4.
	github.com/cometbft/cometbft => github.com/graphprotocol/cometbft v0.37.4-v25-osmo-11-fh
